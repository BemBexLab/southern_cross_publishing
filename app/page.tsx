        ...
        <div className="relative -mt-10 -mb-10 px-4 pb-10 sm:-mt-14 sm:-mb-14 sm:px-6 sm:pb-14 lg:-mt-24 lg:-mb-24 lg:translate-y-[84px] lg:px-8 lg:pb-20">
          <div className="mx-auto grid max-w-[1200px] overflow-hidden rounded-[30px] bg-[#078c52] text-white lg:min-h-[380px] lg:grid-cols-[1.32fr_0.68fr]">
            <div className="flex w-full flex-col justify-center px-6 py-8 sm:px-8 sm:py-9 md:px-10 md:py-10 lg:w-[100%] lg:pl-[40px] lg:pr-0 lg:py-9">
              <p className="dm-sans max-w-full text-sm font-medium tracking-[0.01em] text-[#f6c72f] sm:text-[15px] md:text-base lg:max-w-[44rem] lg:text-[15px]">
                Publish Your Book in Australia: Hire an Book Publisher with a Team That Handles the Complete Process. 
              </p>
              ...
              <h2 className="goneva mt-4 max-w-full text-[2rem] leading-[0.96] text-[#f7f1d7] sm:text-[2.45rem] md:mt-5 md:text-[2.95rem] lg:max-w-full lg:text-[3.1rem]">
                Let Crux  take the hassle out of publishing, so you can focus on your story
              </h2>
              ...
              <p className="dm-sans mt-6 max-w-full text-[0.98rem] leading-7 text-white/92 sm:text-base sm:leading-[1.6] md:text-[1.02rem] md:leading-[1.6] lg:mt-7 lg:max-w-full lg:text-md lg:leading-[1.45]">
              ...
              <a
                href="/contact"
                className="dm-sans mt-7 inline-flex w-fit items-center gap-3 rounded-[10px] bg-[#FDD118] px-6 py-4 text-lg font-semibold text-[#067446] transition-transform duration-200 hover:-translate-y-0.5 sm:mt-8 sm:px-7 sm:text-[1.05rem] md:mt-7 md:px-7 md:py-4 md:text-base lg:mt-9 lg:px-7 lg:py-4"
              >
