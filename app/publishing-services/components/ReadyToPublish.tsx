...
const ReadyToPublish = ({
  ...
  eyebrowClassName = "montserrat mb-3 text-base font-medium text-[#FDD118] sm:text-lg",
  titleClassName = "mb-4 max-w-2xl text-3xl leading-tight text-[#F7F1D7] sm:text-4xl lg:text-[2.75rem]",
  descriptionClassName = "montserrat mb-8 max-w-2xl text-base leading-relaxed text-[#F7F1D7] sm:text-lg sm:leading-8 lg:mb-10",
