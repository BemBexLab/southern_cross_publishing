        ...
        <div className="mx-auto max-w-[1180px]">
          <div className="grid gap-10 lg:grid-cols-[minmax(0,1fr)_290px] lg:gap-12">
            <div>
              <Link
                href="/blog"
                className="dm-sans inline-flex items-center gap-2 rounded-md bg-[#8fd387] px-3 py-2 text-sm font-medium text-[#14522f] transition hover:bg-[#7dca74]"
              >
              ...
              <div className="mt-8 overflow-hidden rounded-[10px] border border-[#e5dbc1] bg-[#fff9e9] shadow-[0_10px_24px_rgba(80,64,24,0.06)]">
                {featuredImage?.source_url ? (
                  ...
                  <div className="flex min-h-[280px] items-center justify-center bg-[radial-gradient(circle_at_top,#f2f6b5,transparent_58%),linear-gradient(135deg,#fff4d4,#efe4b8)] px-8 py-10 text-center">
                    <div>
                      <p className="dm-sans text-xs font-semibold uppercase tracking-[0.24em] text-[#99831a]">
              ...
              <div className="dm-sans mt-4 flex flex-wrap items-center gap-x-5 gap-y-2 text-[0.78rem] text-[#a1967c]">
              ...
              <div className="mt-5">
                {excerpt ? (
                  <p className="dm-sans text-[0.97rem] leading-[1.75] text-[#6d665a]">
                    {excerpt}
                  </p>
                ) : null}
              </div>
              ...
              <div className="mt-10 flex flex-wrap items-center justify-between gap-4 rounded-[12px] bg-[#ebe0b9] px-5 py-4 text-[#2c2a25]">
                <div>
                  <p className="dm-sans text-sm uppercase tracking-[0.16em] text-[#018752]">
                    Want more publishing insights?
                  </p>
                  <p className="dm-sans mt-1 text-sm leading-6 text-[#534d41]">
                ...
                <div className="flex flex-wrap gap-3">
                  <Link
                    href="/blog"
                    className="dm-sans inline-flex min-h-11 items-center justify-center rounded-md border border-[#018752] px-5 text-sm font-semibold text-[#018752] transition hover:bg-[#018752] hover:text-[#f7f1d7]"
                  >
                    View all posts
                  </Link>
                  <a
                    ...
                    target="_blank"
                    rel="noreferrer"
                    className="dm-sans inline-flex min-h-11 items-center justify-center gap-2 rounded-md bg-[#fdd118] px-5 text-sm font-semibold text-[#018752] transition hover:bg-[#ffd53b]"
                  >
                    Open source article
            ...
            <aside className="lg:border-l lg:border-[#d9ccaa] lg:pl-8">
              <div className="lg:sticky lg:top-32">
                <div className="rounded-[10px] bg-[#252525] p-5 text-[#f7f1d7] shadow-[0_18px_35px_rgba(24,20,12,0.18)]">
                  <h2 className="dm-sans text-[1.05rem] font-semibold leading-[1.2] text-[#fdd118]">
                    Subscribe to Our Newsletter
                  </h2>
                  <p className="dm-sans mt-3 text-[0.76rem] leading-[1.55] text-[#ddd5c3]">
                  ...
                  <div className="mt-4 space-y-3">
                    <input
                      ...
                      className="dm-sans h-10 w-full rounded-[4px] border-none bg-[#fff7df] px-4 text-sm text-[#44413b] placeholder:text-[#9f9b8d] focus:outline-none"
                    />
                    <button
                      type="button"
                      className="dm-sans flex h-10 w-full items-center justify-center rounded-[4px] bg-[#fdd118] px-4 text-sm font-semibold text-[#1d5f3f] transition hover:bg-[#ffd53b]"
                    >
                      Subscribe Now
                    </button>
                  </div>
                ...
                <div className="mt-8">
                  <h3 className="dm-sans text-[1rem] font-semibold text-[#23a05f]">
                    Recent Posts
                  </h3>
                  <div className="mt-4 space-y-4">
                    {recentPosts.map((recentPost) => (
                      ...
                      >
                        <p className="dm-sans text-[0.8rem] leading-[1.5] text-[#7e786a]">
                          {recentPost.title}
                        </p>
                        <p className="dm-sans mt-1 text-[0.7rem] text-[#b0a48a]">
                          {recentPost.date}
                        </p>
                      </Link>
                    ))}
