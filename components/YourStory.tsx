...
const storyParagraphs = [
  ...
  "At Southern Cross Publishing, we've created our complete process around keeping that feeling alive, from your very first conversation with us to the day your book lands in a reader's hands.",
